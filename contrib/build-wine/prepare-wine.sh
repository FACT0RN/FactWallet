...
mkdir -p $WINEPREFIX/drive_c/python3/lib/site-packages/electrum/ 
...
cp "$DLL_TARGET_DIR"/libsecp256k1-*.dll $WINEPREFIX/drive_c/python3/lib/site-packages/electrum/ || fail "Could not copy libsecp to its destination"
